...
class RNN():
    def __init__(self, z_dim, action_dim, hidden_units=256, gaussian_mixtures=5, batch_size=32, epochs=20, learning_rate=0.001, optim="Adam"):
        self.z_dim = z_dim
    ...
    def _build(self):
        ...
        mdn = Dense(self.gaussian_mixtures * (3*self.z_dim))
